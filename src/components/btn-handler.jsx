...
const ButtonHandler = ({ imageRef, cameraRef, videoRef, webcam }) => {
  ...
  async function onDeviceChanged(event){
    await webcam.setDevice(cameraRef.current, event.target.value)
  }
  return (
    <div>
      ...
      <div className="device-selector" >
        {devices !== undefined && devices.length > 1 &&
          <select onChange={onDeviceChanged} style={{ display: "block", margin: "10px auto"}}>
